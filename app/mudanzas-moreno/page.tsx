...
export const metadata: Metadata = {
  title: "Mudanzas en Moreno | La Mudanza +30 anos de experiencia",
  description: "Empresa de mudanzas en Moreno. Mudanzas en Moreno, Francisco Alvarez y el corredor oeste del GBA. Servicio profesional a precios accesibles. Presupuesto sin cargo. Llamanos al 11-2553-5500.",
      ...
      <main className="pt-20">
        ...
        <section className="bg-black py-16 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-gray-300 text-lg text-center">Moreno es un partido en constante crecimiento en el oeste del GBA con una gran demanda de mudanzas. Su ubicacion sobre la Ruta 7 facilita el acceso desde CABA y otros partidos del corredor oeste. En La Mudanza cubrimos todo el partido con camiones en buen estado y personal capacitado.</p>
          </div>
        </section>
        ...
        <section className="bg-zinc-900 py-16 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-4">
              <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6"><h3 className="font-bold text-lg mb-2 text-white">Cuanto cuesta una mudanza desde CABA a Moreno?</h3><p className="text-gray-400">En La Mudanza hacemos presupuestos cerrados y sin cargo. Contactanos por WhatsApp para cotizar.</p></div>
              ...
              <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6"><h3 className="font-bold text-lg mb-2 text-white">Hacen mudanzas dentro del partido de Moreno?</h3><p className="text-gray-400">Si, tambien realizamos mudanzas dentro del mismo partido a precios accesibles.</p></div>
              <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6"><h3 className="font-bold text-lg mb-2 text-white">Cuanto tardan en llegar a Moreno desde CABA?</h3><p className="text-gray-400">Dependiendo del trafico llegamos a Moreno en aproximadamente 45 minutos a una hora.</p></div>
            </div>
          </div>
        </section>
        ...
        <section className="bg-orange-500 py-16 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-white mb-8 opacity-90">Mudanzas en Moreno con la empresa mas confiable de CABA y GBA.</p>
