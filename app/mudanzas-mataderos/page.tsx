...
export const metadata: Metadata = {
  title: "Mudanzas en Mataderos | La Mudanza +30 anos de experiencia",
  description: "Empresa de mudanzas en Mataderos. Mudanzas en Mataderos, Liniers y Villa Lugano. Servicio profesional en el sur y oeste de CABA con precios accesibles. Presupuesto sin cargo. Llamanos al 11-2553-5500.",
      ...
      <main className="pt-20">
        ...
        <section className="bg-zinc-900 py-16 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6"><h3 className="font-bold text-lg mb-2 text-white">Cuanto cuesta una mudanza en Mataderos?</h3><p className="text-gray-400">En La Mudanza hacemos presupuestos cerrados y sin cargo. Contactanos por WhatsApp para cotizar.</p></div>
              <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6"><h3 className="font-bold text-lg mb-2 text-white">Tienen camiones grandes para casas en Mataderos?</h3><p className="text-gray-400">Si, contamos con camiones de gran capacidad para mudanzas de casas completas.</p></div>
        ...
        <section className="bg-orange-500 py-16 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-white mb-8 opacity-90">Mudanzas en Mataderos con la empresa mas confiable de CABA.</p>
