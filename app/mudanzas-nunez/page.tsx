...
export const metadata: Metadata = {
  title: "Mudanzas en Nunez | La Mudanza +30 anos de experiencia",
  description: "Empresa de mudanzas en Nunez. Mudanzas en Nunez, Saavedra y Coghlan. Zona residencial tranquila del norte de CABA con casas de familia y edificios modernos. Presupuesto sin cargo. Llamanos al 11-2553-5500.",
      ...
      <main className="pt-20">
        ...
        <section className="bg-zinc-900 py-16 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-4">
              <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6"><h3 className="font-bold text-lg mb-2 text-white">Cuanto cuesta mudarse en Nunez?</h3><p className="text-gray-400">En La Mudanza hacemos presupuestos cerrados y sin cargo. Contactanos por WhatsApp para cotizar.</p></div>
              <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6"><h3 className="font-bold text-lg mb-2 text-white">Cubren Saavedra y Coghlan ademas de Nunez?</h3><p className="text-gray-400">Si, cubrimos toda la zona norte de CABA incluyendo Nunez, Saavedra y Coghlan.</p></div>
              <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6"><h3 className="font-bold text-lg mb-2 text-white">Pueden mover objetos grandes en casas de Nunez?</h3><p className="text-gray-400">Si, tenemos experiencia con muebles grandes, pianos y objetos voluminosos.</p></div>
        ...
        <section className="bg-orange-500 py-16 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-white mb-8 opacity-90">Mudanzas en Nunez con la empresa mas confiable de CABA.</p>
