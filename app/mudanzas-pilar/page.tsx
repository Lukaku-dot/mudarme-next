...
export const metadata: Metadata = {
  title: "Mudanzas en Pilar | La Mudanza +30 anos de experiencia",
  description: "Empresa de mudanzas en Pilar. Mudanzas en Pilar, Del Viso y countries del corredor norte. Especialistas en barrios cerrados y countries de la zona. Presupuesto sin cargo. Llamanos al 11-2553-5500.",
      ...
      <main className="pt-20">
        ...
        <section className="bg-zinc-900 py-16 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-4">
              <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6"><h3 className="font-bold text-lg mb-2 text-white">Cuanto cuesta una mudanza desde CABA a Pilar?</h3><p className="text-gray-400">En La Mudanza hacemos presupuestos cerrados y sin cargo. La distancia a Pilar implica un costo adicional al traslado local. Contactanos por WhatsApp.</p></div>
              <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6"><h3 className="font-bold text-lg mb-2 text-white">Pueden entrar a countries de Pilar?</h3><p className="text-gray-400">Si, tenemos experiencia en los principales countries de Pilar. Gestionamos los permisos de ingreso con anticipacion.</p></div>
              ...
              <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6"><h3 className="font-bold text-lg mb-2 text-white">Con cuanta anticipacion hay que reservar para Pilar?</h3><p className="text-gray-400">Para mudanzas a countries de Pilar recomendamos reservar con al menos 10 dias de anticipacion.</p></div>
            </div>
          </div>
        </section>
        ...
        <section className="bg-orange-500 py-16 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-white mb-8 opacity-90">Mudanzas en Pilar con la empresa mas confiable de CABA y GBA.</p>
