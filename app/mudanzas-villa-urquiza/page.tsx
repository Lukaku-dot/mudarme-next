...
export const metadata: Metadata = {
  title: "Mudanzas en Villa Urquiza | La Mudanza +30 anos de experiencia",
  description: "Empresa de mudanzas en Villa Urquiza. Mudanzas en Villa Urquiza, Saavedra y Villa del Parque. Barrio residencial del norte de CABA con gran demanda de mudanzas familiares. Presupuesto sin cargo. Llamanos al 11-2553-5500.",
      ...
      <main className="pt-20">
        ...
        <section className="bg-black py-16 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-gray-300 text-lg text-center">Villa Urquiza es un barrio de casas con jardin y edificios bajos donde las mudanzas suelen ser mas tranquilas. En La Mudanza hemos realizado cientos de mudanzas en Villa Urquiza y sus alrededores, conocemos el barrio y sabemos como organizarnos para que todo salga perfecto.</p>
          </div>
        </section>
        ...
        <section className="bg-zinc-900 py-16 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-4">
              <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6"><h3 className="font-bold text-lg mb-2 text-white">Trabajan en casas con jardin en Villa Urquiza?</h3><p className="text-gray-400">Si, tenemos experiencia en mudanzas de casas con jardin en Villa Urquiza.</p></div>
        ...
        <section className="bg-orange-500 py-16 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-white mb-8 opacity-90">Mudanzas en Villa Urquiza con la empresa mas confiable de CABA.</p>
