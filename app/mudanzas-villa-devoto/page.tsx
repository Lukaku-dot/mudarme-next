...
export const metadata: Metadata = {
  title: "Mudanzas en Villa Devoto | La Mudanza +30 anos de experiencia",
  description: "Empresa de mudanzas en Villa Devoto. Mudanzas en Villa Devoto, Villa del Parque y Monte Castro. Barrios familiares del oeste de CABA con casas amplias. Presupuesto sin cargo. Llamanos al 11-2553-5500.",
      ...
      <main className="pt-20">
        ...
        <section className="bg-black py-16 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-gray-300 text-lg text-center">Villa Devoto es uno de los barrios mas tranquilos y familiares de CABA, con casas de dos plantas, jardines y calles arboladas. En La Mudanza nos especializamos en mudanzas de casas y conocemos bien las particularidades de Villa Devoto y sus alrededores.</p>
          </div>
        </section>
        ...
        <section className="bg-zinc-900 py-16 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6"><h3 className="font-bold text-lg mb-2 text-white">Cuanto cuesta mudarse en Villa Devoto?</h3><p className="text-gray-400">En La Mudanza hacemos presupuestos cerrados y sin cargo. Contactanos por WhatsApp para cotizar.</p></div>
              <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6"><h3 className="font-bold text-lg mb-2 text-white">Cubren Villa del Parque y Monte Castro?</h3><p className="text-gray-400">Si, ademas de Villa Devoto cubrimos Villa del Parque, Monte Castro y todos los barrios del corredor oeste.</p></div>
        ...
        <section className="bg-orange-500 py-16 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-white mb-8 opacity-90">Mudanzas en Villa Devoto con la empresa mas confiable de CABA.</p>
