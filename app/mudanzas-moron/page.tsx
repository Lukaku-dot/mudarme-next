...
export const metadata: Metadata = {
  title: "Mudanzas en Moron | La Mudanza +30 anos de experiencia",
  description: "Empresa de mudanzas en Moron. Mudanzas en Moron, Haedo y El Palomar. Servicio eficiente en el oeste del Gran Buenos Aires. Presupuesto sin cargo. Llamanos al 11-2553-5500.",
      ...
      <main className="pt-20">
        ...
        <section className="bg-black py-16 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-gray-300 text-lg text-center">Moron es el centro del GBA Oeste y un hub clave para mudanzas en la region. Su ubicacion sobre la autopista del Oeste facilita el acceso desde CABA. En La Mudanza cubrimos todo el partido con camiones equipados y personal con experiencia en la zona.</p>
          </div>
        </section>
        ...
        <section className="bg-zinc-900 py-16 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-4">
              <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6"><h3 className="font-bold text-lg mb-2 text-white">Cuanto cuesta una mudanza desde CABA a Moron?</h3><p className="text-gray-400">En La Mudanza hacemos presupuestos cerrados y sin cargo. Contactanos por WhatsApp para cotizar.</p></div>
              ...
              <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6"><h3 className="font-bold text-lg mb-2 text-white">Hacen mudanzas hacia Ituzaingo y Merlo?</h3><p className="text-gray-400">Si, ademas de Moron cubrimos Ituzaingo, Hurlingham y Merlo.</p></div>
        ...
        <section className="bg-orange-500 py-16 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-white mb-8 opacity-90">Mudanzas en Moron con la empresa mas confiable de CABA.</p>
