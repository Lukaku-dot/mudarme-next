...
export const metadata: Metadata = {
  title: "Mudanzas en Almagro | La Mudanza +30 anos de experiencia",
  description: "Empresa de mudanzas en Almagro. Mudanzas en Almagro, Boedo y San Cristobal. Barrios clasicos del centro de CABA con gran diversidad de viviendas. Presupuesto sin cargo. Llamanos al 11-2553-5500.",
      ...
      <main className="pt-20">
        ...
        <section className="bg-black py-16 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-gray-300 text-lg text-center">Almagro es un barrio bohemio y cultural en el centro de CABA, con una mezcla de edificios antiguos, PH y casas de planta baja. En La Mudanza conocemos los mejores horarios para trabajar en Almagro y como estacionar los camiones sin generar inconvenientes.</p>
          </div>
        </section>
        ...
        <section className="bg-zinc-900 py-16 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6"><h3 className="font-bold text-lg mb-2 text-white">Cuanto cuesta una mudanza en Almagro?</h3><p className="text-gray-400">En La Mudanza hacemos presupuestos cerrados y sin cargo. Contactanos por WhatsApp para cotizar.</p></div>
        ...
        <section className="bg-orange-500 py-16 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-white mb-8 opacity-90">Mudanzas en Almagro con la empresa mas confiable de CABA.</p>
