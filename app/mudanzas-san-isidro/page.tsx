...
export const metadata: Metadata = {
  title: "Mudanzas en San Isidro | La Mudanza +30 anos de experiencia",
  description: "Empresa de mudanzas en San Isidro. Mudanzas en San Isidro, Martinez y Beccar. Especialistas en casas de alto standing y countries del norte del Gran Buenos Aires. Presupuesto sin cargo. Llamanos al 11-2553-5500.",
      ...
      <main className="pt-20">
        ...
        <section className="bg-black py-16 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-gray-300 text-lg text-center">San Isidro es uno de los destinos mas elegantes del norte del GBA, con casas grandes, mobiliario de valor y accesos a countries y barrios privados. En La Mudanza tenemos experiencia en todos los barrios privados de San Isidro y sus alrededores.</p>
          </div>
        </section>
        ...
        <section className="bg-zinc-900 py-16 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-4">
              <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6"><h3 className="font-bold text-lg mb-2 text-white">Pueden entrar a countries de San Isidro?</h3><p className="text-gray-400">Si, tenemos experiencia entrando a countries y barrios privados de San Isidro. Gestionamos el permiso de ingreso con anticipacion.</p></div>
              <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6"><h3 className="font-bold text-lg mb-2 text-white">Cuanto cuesta una mudanza a San Isidro desde CABA?</h3><p className="text-gray-400">En La Mudanza hacemos presupuestos cerrados y sin cargo. Contactanos por WhatsApp para cotizar.</p></div>
              ...
              <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6"><h3 className="font-bold text-lg mb-2 text-white">Hacen mudanzas de fin de semana en San Isidro?</h3><p className="text-gray-400">Si, trabajamos sabados en San Isidro. Para countries hay que consultar los horarios permitidos por cada administracion.</p></div>
            </div>
          </div>
        </section>
        ...
        <section className="bg-orange-500 py-16 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-white mb-8 opacity-90">Mudanzas en San Isidro con la empresa mas confiable de CABA.</p>
