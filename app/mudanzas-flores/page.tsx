...
export const metadata: Metadata = {
  title: "Mudanzas en Flores | La Mudanza +30 anos de experiencia",
  description: "Empresa de mudanzas en Flores. Mudanzas en Flores, Floresta y Parque Chacabuco. Servicio rapido y economico en el oeste de CABA con amplia cobertura de barrios. Presupuesto sin cargo. Llamanos al 11-2553-5500.",
      ...
      <main className="pt-20">
        <section className="bg-black text-white py-16 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-gray-300 text-lg mb-8">Mudanzas en Flores, Floresta y Parque Chacabuco. Servicio rapido y economico en el oeste de CABA con amplia cobertura de barrios.</p>
        ...
        <section className="bg-black py-16 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-gray-300 text-lg text-center">Flores es un barrio de familias con casas grandes y muchos muebles, lo que requiere camiones de buena capacidad y personal con experiencia en traslados voluminosos. En La Mudanza conocemos las particularidades de Rivadavia, Carabobo y las calles internas del barrio.</p>
          </div>
        </section>
        ...
        <section className="bg-zinc-900 py-16 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-4">
              <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6"><h3 className="font-bold text-lg mb-2 text-white">Hacen mudanzas de casas grandes en Flores?</h3><p className="text-gray-400">Si, somos especialistas en mudanzas de casas de 3, 4 y 5 ambientes en Flores con camiones de gran capacidad.</p></div>
              ...
              <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-6"><h3 className="font-bold text-lg mb-2 text-white">Cuanto cuesta una mudanza de casa en Flores?</h3><p className="text-gray-400">En La Mudanza hacemos presupuestos cerrados y sin cargo. Contactanos por WhatsApp para cotizar.</p></div>
        ...
        <section className="bg-orange-500 py-16 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-white mb-8 opacity-90">Mudanzas en Flores con la empresa mas confiable de CABA.</p>
